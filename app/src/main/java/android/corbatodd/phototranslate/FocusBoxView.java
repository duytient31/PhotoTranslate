...
public class FocusBoxView extends View {
    ...
    private  Rect getBoxRect() {
        ...
        if (box == null) {
            ...
            ScrRes = CheckFocusBox.getScreenResolution(getContext());
            ...
            height = height == 0 ? MIN_FOCUS_BOX_HEIGHT : height < MIN_FOCUS_BOX_HEIGHT ? MIN_FOCUS_BOX_HEIGHT : height;
                            ...
                            try {
                                ...
                                if (lastX >= 0) {
                                    if (((currentX >= rect.left - BIG_BUFFER && currentX <= rect.left + BIG_BUFFER) || (lastX >= rect.left - BIG_BUFFER && lastX <= rect.left + BIG_BUFFER)) && ((currentY <= rect.top + BIG_BUFFER && currentY >= rect.top - BIG_BUFFER) || (lastY <= rect.top + BIG_BUFFER && lastY >= rect.top - BIG_BUFFER))) {
                                        updateBoxRect(2 * (lastX - currentX), 2 * (lastY - currentY));
                                        ...
                                        updateBoxRect(2 * (currentX - lastX), 2 * (lastY - currentY));
                                        ...
                                        updateBoxRect(2 * (lastX - currentX), 2 * (currentY - lastY));
                                        ...
                                        updateBoxRect(2 * (currentX - lastX), 2 * (currentY - lastY));
